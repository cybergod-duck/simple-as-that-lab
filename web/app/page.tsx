          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#2D1B69]/60 border border-cyan-500/30 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <button className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold py-3 px-4 rounded-lg transition-all">
                  Discord
                </button>
                ...
                <button className="w-full bg-[#0088cc] hover:bg-[#006699] text-white font-semibold py-3 px-4 rounded-lg transition-all mt-4">
                  Telegram
                </button>
